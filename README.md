...
3. Run it.
4. The script will download the audio from each video in the playlist and save it as an MP3 file in the `./'` directory (right here/code package) or change it where you desire.
